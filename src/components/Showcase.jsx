    ...
    <section className={`showcase ${type}-showcase`}>
      <div className="showcase-container container">
        <div className="hidden lg:flex absolute left-[120px] mt-[100px]">
          <button
            className="bg-white p-2 rounded-full mr-2 border border-[#dadce0] text-[#1c4980] hover:bg-[#1c4980] hover:text-white custom-prev-button"
        ...
        <div className="hidden lg:flex absolute right-[130px] text-center mt-[-195px]">
          <button
            className="bg-white p-2 rounded-full border border-[#dadce0] text-[#1c4980] hover:bg-[#1c4980] hover:text-white custom-next-button"
